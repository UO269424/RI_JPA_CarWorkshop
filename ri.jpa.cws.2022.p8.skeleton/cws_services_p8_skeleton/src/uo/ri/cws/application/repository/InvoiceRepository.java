...
public interface InvoiceRepository extends Repository<Invoice> {
    ...
    /**
     * @return el siguiente número de factura a usar, es decir, el mayor
     *         número existente registrado + 1.
     * 
     ...
     *         llegar a obtener el mismo número. El código que use este
     *         método debería tener esto en cuenta.
     */
